...
class _MyAppState extends State<MyApp> {
  ...
  void _setFilters(Map <String,bool> filterData ,BuildContext ctx) {//ctx my change not there
    setState(() {
      _filters=filterData;
    });
    ...
    Navigator.of(ctx).pushReplacementNamed('/');//my change not there
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        FiltersScreen.routenName:(ctx)=>FiltersScreen(_setFilters),
      },
